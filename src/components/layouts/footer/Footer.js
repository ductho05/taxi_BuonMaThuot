    ...
    return (
        <div className={cx('wrapper', 'grid')}>
            <div className="row">
                <div className={cx('description', 'col l-3 m-4 c-12')}>
                    ...
                    <p className={cx('content')}>
                        Chúng tôi đã tạo ra taxi của mình để giúp bạn tìm được dịch vụ taxi đáng tin cậy nhất và chất
                        lượng cao nhất, mọi lúc, mọi nơi mà không gặp bất kỳ trở ngại nào.
                    </p>
                </div>
            ...
            <div className={cx('bottom')}>
                <p className={cx('copyright')}>Mr.ThoThemes © 2023. All Rights Reserved.</p>
            </div>
        </div>
    );
};
